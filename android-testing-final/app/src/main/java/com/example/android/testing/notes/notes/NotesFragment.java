...
import com.example.android.testing.notes.util.uploadHelper;
...
public class NotesFragment extends Fragment implements NotesContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activity=     (NotesActivity) getActivity();
    ...
    public void showAddNote() {
      ...
      //  PoijiOptions options = PoijiOptions.PoijiOptionsBuilder.settings(0).build(); // we eliminate Joe Doe.
       // stream = openFileFromInternal("patients.xls");
      //  uploadHelper.uploadExcel();
    ...
    private class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            {
                activity = NotesFragment.this.getActivity();
            }
            ...
            public ViewHolder(View itemView, NoteItemListener listener) {
              ...
              /*  description.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent pss=  new Intent(android.content.Intent.ACTION_VIEW);
                        String url=description.getText().toString();
                        final Uri parse = Uri.parse(url);
                        pss.setData(parse);
                        activity.startActivity(pss);
                    }
                });*/
            }
