...
public class AddNotePresenter implements AddNoteContract.UserActionsListener {
    ...
    public void saveNote(String title, String description) {
       ...
       // Note newNote = new Note(title, description, imageUrl);
        final List<Patient> patients = uploadHelper.uploadExcel();
        if (patients.isEmpty()) {
    ...
    public void imageAvailable() {
       // if (mImageFile.exists()) {
            mAddNoteView.showImagePreview("https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png");
      //  } else {
         //   imageCaptureFailed();
      //  }
    }
